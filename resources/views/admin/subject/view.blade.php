...
<div class="min-w-full p-6" style="min-height: 560px">
    ...
    <table class="min-w-full bg-white rounded-lg">
        <thead>
            <tr>
            <th class="text-left p-3 border-b border-gray-200">Strand</th><th class="text-left p-3 border-b border-gray-200">Section</th>
        ...
        <tbody>
            ...
            <td class="text-left p-3 border-b border-gray-200">{{ $student->section ?? 'N/A'  }}</td>
                ...
                <a href="" class="px-2 py-1 bg-blue-500 text-white rounded-md">Edit</a>
                            ...
                            <form id="delete-form-{{ $subject->id }}" action="" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                </td>
