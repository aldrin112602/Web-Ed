    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div class="bg-white shadow rounded-lg p-5 flex items-center">
                <div class="flex-grow">
                    <p class="text-2xl font-bold text-slate-800">0 Present</p>
            ...
            <div class="bg-white shadow rounded-lg p-5 flex items-center">
                <div class="flex-grow">
                    <p class="text-2xl font-bold text-slate-800">0 Absent</p>
            ...
            <div class="bg-white shadow rounded-lg p-5 flex items-center">
                <div class="flex-grow">
                    <p class="text-2xl font-bold text-slate-800">0 Late Arrival</p>
