            ...
            <table id="tbl_list" class="min-w-full bg-white border border-gray-200">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-2 text-center border">
                            <a href="{{ route('teacher.view.subjects', $list->id) }}" class="px-2 py-1 bg-indigo-600 text-white rounded-md">View</a>
                        </td>
                        <td class="py-2 text-center border">
                            <a href="{{ route('teacher.edit.student', $list->id) }}?id={{$id}}" class="px-2 py-1 bg-blue-500 text-white rounded-md">Edit</a>
