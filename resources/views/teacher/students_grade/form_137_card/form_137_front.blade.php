    ...
    <div id="form_137" class="border p-8 shadow-lg">
        ...
        <div class="border-t pt-4 mt-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex items-center justify-start gap-2">
                    ...
                    <input style="font-size: 14px; display: inline-block !important;" value="Ark Technological Institute Education System Inc" type="text" class="w-full border-0 border-b border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-600 p-1">
                </div>
                <div class="flex items-center justify-start gap-2">
        ...
        <div class="my-8">
            <table class="w-full border-collapse border border-gray-400 mb-8">
                ...
                <tbody>
                    @foreach ($grades['Second Semester_First Quarter'] as $firstQuarter)
                    <tr>
                        <td class="border border-gray-400 p-2 text-center" contenteditable="">Core</td>
                        <td class="border border-gray-400 p-2 text-center">{{ $firstQuarter->subject }}</td>
                        <td class="border border-gray-400 p-2 text-center">{{ $firstQuarter->quarterly_grade }}</td>
                        <td class="border border-gray-400 p-2 text-center">
                            {{ optional($grades['Second Semester_Second Quarter']->firstWhere('subject', $firstQuarter->subject))->quarterly_grade ?? 'N/A' }}
                        </td>
                        <td class="border border-gray-400 p-2 text-center">
                            {{
                        ($firstQuarter->quarterly_grade +
                        optional($grades['Second Semester_Second Quarter']->firstWhere('subject', $firstQuarter->subject))->quarterly_grade) / 2
                    }}
                        </td>
                        <td class="border border-gray-400 p-2 text-center" contenteditable="true"></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4" class="bg-gray-200 p-2 text-right">General Average for the semester: </td>
                        <td class="border border-gray-400 p-2 text-center">
                            {{ $grades['Second Semester_First Quarter']->average('quarterly_grade')?? 'N/A' }}
                        </td>
                        <td class="border border-gray-400 p-2 text-center"></td>
                    </tr>
                </tbody>
