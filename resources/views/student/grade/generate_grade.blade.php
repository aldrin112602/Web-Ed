...
<div class="max-w-2xl mx-auto mt-10 p-6 bg-white shadow-md rounded-md">
    ...
    <div class="text-center mb-8">
        <img src="{{ asset('webed img/webed img/admin ark logo.jpg') }}" alt="Logo" class="mx-auto h-16 mb-4">
        <h1 class="text-lg font-bold">Ark Technological Institute Education System Inc.</h1>
