    ...
    <main class="min-h-screen">
        ...
        <div class="block md:flex h-screen items-start justify-start">
            ...
            <div class="hidden md:block  p-4 bg-white shadow border-r" style="height: 100%; min-width: 280px">
                ...
                <div class="p-3 {{ request()->is('student/profile') ? 'bg-blue-50 text-blue-500' : 'hover:bg-blue-50 hover:text-blue-500 text-gray-700' }} rounded">
                ...
                <div class="p-3 {{ request()->is('student/attendance_report') ? 'bg-blue-50 text-blue-500' : 'hover:bg-blue-50 hover:text-blue-500 text-gray-700' }} rounded">
                    <a href="" class="text-sm flex items-center justify-start gap-3"><i class="fa-solid fa-cube"></i>Attendance Report</a>
                </div>

                <div class="p-3 {{ request()->is('student/attendance_history') ? 'bg-blue-50 text-blue-500' : 'hover:bg-blue-50 hover:text-blue-500 text-gray-700' }} rounded">
                    <a href="{{ route('student.attendance_history') }}" class="text-sm flex items-center justify-start gap-3"><i class="fa-solid fa-clock-rotate-left"></i>Attendance History</a>
                </div>
