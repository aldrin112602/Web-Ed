    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="p-4 shadow-md rounded-lg">
            ...
            <div class="grid grid-cols-1 gap-4">
                <div class="text-center p-4 shadow rounded bg-white">Java</div>
                <div class="text-center p-4 shadow rounded bg-white">Earth and Life</div>
                <div class="text-center p-4 shadow rounded bg-white">General Mathematics</div>
            </div>
        </div>
        ...
        <div class="col-span-2 p-4 shadow-md rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                <div class="text-center p-4 shadow rounded bg-white cursor-pointer">Java Programming</div>
                <div class="text-center p-4 shadow rounded bg-white cursor-pointer">Earth and Life</div>
            </div>
        </div>
    </div>
