...
<head>
    ...
    <title>WebEd - Revolutionizing Education</title>
...
<body class="antialiased text-gray-900">
    ...
    <header class="relative bg-blue-500 text-white bg-cover bg-center" style="background-image: url('{{ asset('images/admin_auth_bg.png') }}');">
        <!-- Dark Overlay -->
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                    ...
                    <p class="text-gray-600">Ensure data security and reliability with WebEd's robust security measures.</p>
                </div>
                <!-- Feature 6 -->
                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                    <div class="flex items-center justify-center mb-4">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600">Access WebEd on any device with our responsive and mobile-optimized design.</p>
                </div>
            </div>
    </section>
    ...
    <section class="py-20">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-semibold mb-4">Join WebEd Today!</h2>
            <p class="text-lg mb-8">Experience a smarter way to manage education. Whether you're an admin, teacher, student, or guidance counselor, WebEd has the tools you need.</p>
    ...
    <footer class="bg-gray-800 text-white py-6">
        <div class="container mx-auto px-4 text-center">
            <p>&copy; {{ date('Y') }} WebEd. All rights reserved.</p>
            <div class="mt-4">
