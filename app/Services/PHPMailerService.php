...
class PHPMailerService
{
    ...
    public function sendAccountCredentials($to, $username, $password, $name, $user)
    {
        try {
            // Define login URL
            $loginUrl = "https://mywebed.com/$user/login";
    ...
    public function sendAttendance($to, $data)
    {
        try {
            ...
            // Email content setup
            $this->mailer->isHTML(true);
            $this->mailer->Subject = 'Quarterly Attendance Report - WebEd';
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>Below is the Quarterly Attendance Report for your child, <strong>' . $data['student_name'] . '</strong>, for the <strong>' . $data['quarter'] . '</strong> in <strong>Grade ' . $data['grade'] . ' ' . $data['strand'] . ' ' . $data['section'] . '</strong> at <strong>Ark Technological Institute</strong>. This report includes a summary of their absences and tardiness during the quarter.</p>
                ...
                <div class="footer">
                    &copy; ' . date("Y") . ' Ark Technological Institute. All rights reserved.
                </div>
            </div>
        </body>
        </html>';
